...
const MovieInfo = () => {
	...
	className="fixed top-10 right-1 sm:right-5 md:right-10 cursor-pointer font-bold"
>
	Close
</span>
				...
				<div className="p-2 sm:p-4">
					...
					<div className="flex justify-start flex-col sm:flex-row gap-2 sm:gap-4 text-xs sm:text-sm md:text-base">
						...
						<div className="flex flex-col gap-1 sm:gap-2">
							...
							<div className="opacity-100 text-justify">
								<b>To Close this tab click on the close button on the Rightmost Side</b>
							</div>
						</div>
					</div>
				</div>
